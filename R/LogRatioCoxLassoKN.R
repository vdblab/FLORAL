LogRatioCoxLassoKN <- function(x,
  ...
  fullfit <- cox_enet_al_kn(cbind(x,xk),t,d,tj,length.lambda,mu,maxiter,lambda,wcov,a,adjust,ncov,devnull,progress,FALSE,FALSE,notcv=TRUE)
