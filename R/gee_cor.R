gee_cor_R <-
  function(N, # number of subjects
    ...
    # Update the parameter (alfa_hat) for working correlation matrix
    ...
    Ehat<-array(0,c(maxclsz,maxclsz,N)) # For each subject, the corr matrix is maxclsz by maxclsz
