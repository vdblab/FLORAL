LogRatioTDCoxLassoKN <- function(x,
                                 y,
                                 ncov,
                                 length.lambda=100,
  ...
  fullfit <- cox_timedep_enet_al_kn(cbind(x,xk),t0,t1,d,tj,length.lambda,mu,maxiter,lambda,wcov,a,adjust,ncov,devnull,progress)
